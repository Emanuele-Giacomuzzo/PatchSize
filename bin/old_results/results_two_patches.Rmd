...
png(file = here("results", "figures", disturbance_global_input, "paper_two_patches_productivity.png"),
    width = paper_width,
    height = paper_height,
    units = paper_units,
    res = paper_res)
...
```{r fig-connected-systems}
### --- Biodiversity PAPER --- ###
png(file = here("results", "figures", disturbance_global_input, "paper_two_patches_biodiversity.png"),
    width = paper_width,
    height = 23,
    units = paper_units,
    res = paper_res)
...
#Define the range of values of Shannon and Bray Curtis
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_1.png"),
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_2.png"),
    width = presentation_figure_width,
    height = presentation_figure_height,
    units = presentation_figure_units,
    res = presentation_figure_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_3.png"),
    width = presentation_figure_width,
    height = presentation_figure_height,
    units = presentation_figure_units,
    res = presentation_figure_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_4.png"),
    width = presentation_figure_width,
    height = presentation_figure_height,
    units = presentation_figure_units,
    res = presentation_figure_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_5.png"),
    width = presentation_figure_width,
    height = presentation_figure_height,
    units = presentation_figure_units,
    res = presentation_figure_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_6.png"),
    width = presentation_figure_width,
    height = presentation_figure_height,
    units = presentation_figure_units,
    res = presentation_figure_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_two_patch_systems_7.png"),
    width = presentation_figure_width,
    height = presentation_figure_height,
    units = presentation_figure_units,
    res = presentation_figure_res)
