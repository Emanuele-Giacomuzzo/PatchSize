...
for (comb_i in 1:bootstrap_iterations) {
  ...
  if (is.null(model)) {
    cat("This model could not be fitted with any optimiser.",
        " The unconnected meta-ecosystems in this iteration were:", 
...
<details>
<summary>Iterated results - P value distributions</summary>
```{r}

# --- SHOW ITERATED RESULTS - P VALUE DSITRIBUTIONS --- #
