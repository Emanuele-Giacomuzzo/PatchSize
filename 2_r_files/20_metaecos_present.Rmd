...
ds_metaecosystems_2 = ds_metaecosystems %>%
...
for (i in 1:length(metaecosystem_type_all)) {
  ...
  alpha_plots[[i+1]] = plot.metaecos.points.presentations(ds_metaecosystems_2,
...
for (i in 1:length(metaecosystem_type_all)) {
  ...
  beta_plots[[i+1]] = plot.metaecos.points.presentations(ds_metaecosystems_2,
                                                         metaecosystem_type_all[1:i],
                                                         response_variable,
                                                         legend_row_n_input) +
    theme(plot.margin = unit(c(ggarrange_margin_left,
