...
#### Evaporation by treatment (single disturbance level)

```{r child = here("3_r_files", "evaporation_single_disturbance_level_treatments.Rmd")}
```

#### Evaporation by size (both disturbance levels)
