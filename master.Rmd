...
```{r child = here("r_files", "analysis_metaeco_variable_all.Rmd")}
```
...
```{r child = here("r_files", "paper_metaecosystem_diversity_n_function.Rmd")}
```

```{r child = here("r_files", "present_metaecosystem_diversity_n_function.Rmd"), echo = FALSE}
```

### Ecosystem diversity & function

```{r child = here("r_files", "paper_ecosystems_S_n_L_diversity_n_function.Rmd")} 
```

```{r child = here("r_files", "paper_ecosystems_M_diversity_n_function.Rmd")} 
```

### Ecosystem autotrophic/heterotrophic ratio

```{r child = here("r_files", "paper_ecosystem_auto_hetero_ratio.Rmd")}
```
