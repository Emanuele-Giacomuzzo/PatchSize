...
```{r}
ds_metaecosystems <- ds_metaecosystems %>%
  mutate(type = case_when(metaecosystem_type == "Small-Large unconnected" ~ "asymmetric",
  ...
  mutate(type_2 = case_when(metaecosystem_type == "Small-Large unconnected" ~ "Small-Large",
                            metaecosystem_type == "Small-Large meta-ecosystem" ~ "Small-Large",
                            metaecosystem_type == "Medium-Medium unconnected" ~ "Medium-Medium",
                            metaecosystem_type == "Medium-Medium meta-ecosystem" ~ "Medium-Medium",
                            metaecosystem_type == "Small-Small meta-ecosystem" ~ "Small-Small",
                            metaecosystem_type == "Medium-Medium meta-ecosystem" ~ "Medium-Medium"))
```