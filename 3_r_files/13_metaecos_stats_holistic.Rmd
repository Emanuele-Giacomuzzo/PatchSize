...
```{r}
"High disturbance"
plot.metaecos.points(ds_metaecosystems_both_disturbances %>% filter(disturbance == "high"),
                     metaecosystem_type_selected,
                     connection_selected,
                     response_variable_selected)

"Low disturbance"
plot.metaecos.points(ds_metaecosystems_both_disturbances %>% filter(disturbance == "low"),
                     metaecosystem_type_selected,
                     connection_selected,
                     response_variable_selected)
```
...
```{r}
"High disturbance"
plot.metaecos.replicates(ds_metaecosystems_both_disturbances %>% filter(disturbance == "high"),
                         metaecosystem_type_selected,
                         response_variable_selected)

"Low disturbance"
plot.metaecos.replicates(ds_metaecosystems_both_disturbances %>% filter(disturbance == "low"),
                         metaecosystem_type_selected,
                         response_variable_selected)
```
</details>
