...
```{r child = here("r_files", "results_isolated_patches.Rmd"), eval = show_results}
```

### Two-patches

```{r child = here("r_files", "results_two_patches.Rmd"), eval = show_results}
```

### Connected patches

```{r child = here("r_files", "results_connected_patches.Rmd"), eval = show_results}
```
