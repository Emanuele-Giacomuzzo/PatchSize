...
cat( "\014" )
start_time = Sys.time()
recompute_analyses = TRUE #Lengthy analyses have been suppressed. Set recompute_analyses = TRUE to redo them. 
```
...
ds_biomass_abund = readRDS(here("results", "ds_biomass_abund.RData"))
ds_patches_averaged = readRDS(here("results", "ds_patches_averaged.RData"))
ds_regional_biomass = readRDS(here("results", "ds_regional_biomass.RData"))
ds_body_size = readRDS(here("results", "ds_body_size.RData"))
...
```{r child = here("r_files", "data_biomass_abund.Rmd")}
```

```{r child = here("r_files", "data_patches_averaged.Rmd")}
```

```{r child = here("r_files", "data_regional_biomass.Rmd")}
```

```{r child = here("r_files", "data_body_size.Rmd")}
```

```{r child = here("r_files", "data_classes_averaged.Rmd")}
```

```{r child = here("r_files", "data_median_body_size.Rmd")}
```

```{r child = here("r_files", "data_median_body_size_effect_size.Rmd")}
```
...
```{r child = here("r_files", "biomass_metaeco_MM_SL.Rmd")}
```

```{r child = here("r_files", "biomass_metaeco_SL_SL_from_isolated.Rmd"), eval = FALSE}
```

```{r child = here("r_files", "biomass_metaeco_equally_sized.Rmd")}
```

## Patches: Biomass {.tabset .tabset-dropdown}

```{r child = here("r_files", "biomass_patches_all.Rmd")}
```

```{r child = here("r_files", "biomass_patches_small.Rmd")}
```

```{r child = here("r_files", "biomass_patches_large.Rmd")}
```

```{r child = here("r_files", "biomass_patches_isolated.Rmd")}
```

## Patches: Community Abundance {.tabset .tabset-dropdown}

```{r child = here("r_files", "comm_abundance_patches_small.Rmd")}
```

```{r child = here("r_files", "comm_abundance_patches_large.Rmd")}
```

```{r child = here("r_files", "comm_abundance_patches_isolated.Rmd")}
```

## Patches: Population Abundances {.tabset .tabset-dropdown}

```{r child = here("r_files", "population_abundances_patches_small.Rmd")}
```

```{r child = here("r_files", "population_abundances_patches_large.Rmd")}
```

```{r child = here("r_files", "population_abundances_patches_isolated.Rmd")}
```
...
```{r child = here("r_files", "beta_diversity_metaeco_MM_SL.Rmd")}
```

```{r child = here("r_files", "beta_diversity_metaeco_equally_sized.Rmd")}
```

### Gamma Diversity {.tabset .tabset-dropdown}

```{r child = here("r_files", "gamma_diversity_metaeco_MM_SL.Rmd")}
```

```{r child = here("r_files", "gamma_diversity_metaeco_equally_sized.Rmd")}
```

## Body size distribution {.tabset .tabset-dropdown}

```{r child = here("r_files", "body_size_distribution_gifs.Rmd"), eval = recompute_analyses}
```

```{r child = here("r_files", "body_size_distribution_patches_small.Rmd")}
```

```{r child = here("r_files", "body_size_distribution_patches_large.Rmd")}
```

```{r child = here("r_files", "body_size_distribution_patches_isolated.Rmd")}
```

## Median body size {.tabset .tabset-dropdown}

```{r child = here("r_files", "body_size_median_patches_all.Rmd")}
```

```{r child = here("r_files", "body_size_median_patches_small.Rmd")}
```

```{r child = here("r_files", "body_size_median_patches_large.Rmd")}
```

```{r child = here("r_files", "body_size_median_patches_isolated.Rmd")}
```
