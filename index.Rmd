...
#### Mean Species Richness {.tabset .tabset-pills}

```{r child = here("r_files", "MM_all_vs_SL_all_mean_richness.Rmd"), eval = show_results}
```

#### Mean Shannon {.tabset .tabset-pills}

```{r child = here("r_files", "MM_all_vs_SL_all_mean_shannon.Rmd"), eval = show_results}
```
...
```{r}
save.image(file = here("environments", "before_isolated_patches.RData"))
```
...
```{r child = here("r_files", "isolated_patches_species_richness.Rmd"), eval = show_results}
```
...
#### Species last saw {.tabset .tabset-pills}

```{r child = here("r_files", "small_patches_species_last_saw.Rmd"), eval = show_results}
```
...
```{r child = here("r_files", "large_patches_species_last_saw.Rmd"), eval = show_results}
```
...
```{r child = here("r_files", "SL_shannon.Rmd"), eval = show_results}
```
...
If you want to save some files:
...
```{r child = here("r_files", "paper_figures.Rmd"), eval = show_results}
```
