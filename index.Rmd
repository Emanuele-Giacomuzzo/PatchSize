...
```
Quitting from lines NA-690 (/Users/ema/Documents/GitHub/PatchSizePilot/r_files/body_size_distribution_small_patches.Rmd) 
Error in parse_block(g[-1], g[1], params.src, markdown_mode) : 
  Duplicate chunk label 'small-patches-full-model-body-size-distribution', which has been used for the chunk:
model_1 = lm(
