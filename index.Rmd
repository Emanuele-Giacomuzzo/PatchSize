...
save.image(file = here("environments", "before_ds_metaecos_1_patch_combinations.RData"))
```
...
```{r echo=FALSE, message=FALSE}
save.image(file = here("environments", "before_analysis_metaeco_connection.RData"))
```
