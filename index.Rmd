...
```{r child = here("r_files", "SL_vs_SL_from_isolated_biomass.Rmd"), eval = include_non_clean_scripts}
```

### MM vs MM from isolated {.tabset .tabset-pills}

```{r child = here("r_files", "MM_vs_MM_from_isolated_biomass.Rmd"), eval = include_non_clean_scripts}
```
...
```{r child = here("r_files", "species_densities_patches_small.Rmd")}
```

```{r child = here("r_files", "body_size_distribution_patches_small.Rmd"), eval = include_non_clean_scripts}
```

```{r child = here("r_files", "size_classes_patches_small.Rmd"), eval = include_non_clean_scripts}
```
...
```{r child = here("r_files", "figures_save.Rmd"), eval = save_figures}
```
