...
```{r child = here("r_files", "results_small_patches.Rmd")}
```
...
```{r echo=FALSE, message=FALSE}
#Save environment
save.image(file = here("environments", "environment_before_results_large.RData"))
```

```{r child = here("r_files", "results_large_patches.Rmd")}
```
