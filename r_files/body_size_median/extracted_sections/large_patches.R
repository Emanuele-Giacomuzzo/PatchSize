## ----median-body-size-large-patches-single-ecosystem-plots-------------------------------------------------------------------------
...
## ----median-body-size-large-patches-lnRR-plots-------------------------------------------------------------------------------------
for (disturbance_input in c("low", "high")) {
  print(
    ds_lnRR_median_body_size %>%
...
## ----body-size-median-large-patches-choose-time-points-----------------------------------------------------------------------------
first_time_point = 2
last_time_point = 7


## ----body-size-median-large-patches-full-model-------------------------------------------------------------------------------------
...
## ----body-size-median-large-patches-no-TM------------------------------------------------------------------------------------------
...
## ----body-size-median-large-patches-no-TD------------------------------------------------------------------------------------------
...
## ----body-size-median-large-patches-no-MD------------------------------------------------------------------------------------------
...
## ----body-size-median-large-t2-t7-best-model---------------------------------------------------------------------------------------
best_model = no_PD
par(mfrow = c(2,3))
