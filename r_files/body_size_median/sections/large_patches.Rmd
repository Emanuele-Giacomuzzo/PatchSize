...
```{r median-body-size-large-patches-single-ecosystem-plots}
...
```{r median-body-size-large-patches-lnRR-plots}
for (disturbance_input in c("low", "high")) {
...
[Note: single time points cannot be computed just because I have a single data point as response variable (e.g., one for L (L_L) at low disturbance at time point = 2). Therefore, if I want to see if the lnRR of different treatments differs, I need to compute the confidence intervals.]{.underline}
