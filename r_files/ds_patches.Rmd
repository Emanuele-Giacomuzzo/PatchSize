...
species_richness_vector = ds_patches %>%
  ungroup() %>%
  select(protist_species[1]:protist_species[length(protist_species)]) %>%
  mutate_at(vars(protist_species),
            funs(ifelse(. > 0, 1, 0))) %>%
  rowSums()

ds_patches$species_richness = species_richness_vector
...
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "S"] = "Small isolated"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "S (S_S)"] = "Small connected to small"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "S (S_L)"] = "Small connected to large"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "M"] = "Medium isolated"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "M (M_M)"] = "Medium connected to medium"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "L"] = "Large isolated"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "L (L_L)"] = "Large connected to large"
ds_patches$eco_metaeco_type[ds_patches$eco_metaeco_type == "L (S_L)"] = "Large connected to small"
