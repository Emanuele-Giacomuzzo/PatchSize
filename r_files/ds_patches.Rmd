...
```{r}
#Assemble dataset (expected rows: sum(nr_videos * n_cultures))
ds_patches = import.protist.pop.data(culture_info,
                                     first_time_point,
                                     last_time_point,
                                     protist_species)

test_that("Expected number of rows", {
  expect_equal(nrow(ds_patches), sum(nr_videos * n_cultures))
})
```
...
test_that("Check that species dominance is NaN when the cultures collapsed.",{
...
test_that("Check that the averaging worked well.",{
  expect_equal(nrow(ds_patches),
               (n_cultures - length(patches_to_take_off)) * length(time_points))})

n_rows_ds_patches = nrow(ds_patches)
```
...
test_that("Check that the alpha diversity was calculated right.",{
...
test_that("Check that treatmenrt divergence was calculated right.",{
...
test_that("Check that temporal divergence was calculated right.",{
...
test_that("Check that the median body size is calculated right.",{
