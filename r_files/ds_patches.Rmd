...
#I'm not sure why this is not already done automatically in the previous step 
ds_patches$shannon[ds_patches$species_richness == 1] = 0
...
#This is the difference in community composition of each culture from its previous time point (Bray-Curtis).
