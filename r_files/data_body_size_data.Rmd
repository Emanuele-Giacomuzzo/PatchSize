...
saveRDS(ds_body_size, file = here("results", "ds_body_size.RData"))
...
To see what happens, let's set the largest size to the one of @Jacquet2020. 

```{r}
largest_size = exp(11.4) 
```
