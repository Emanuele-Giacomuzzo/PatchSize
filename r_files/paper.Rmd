...
#### Meta-ecosystem: total area of patches, but not their size ratio, determines function.

#### Meta-ecosystem: non-living material flows induce ecological homogenization.
...
results_table %>%
  filter(Response %in% c("Bioarea Density ES", "Shannon Index ES")) %>%
  arrange(Response, Levels) %>%
