...
#Expected number of rows: 12 size classes * 8 patch_types * 2 disturbance types * 8 time points = 1536
```
    ...
    for (time_point_input in 0:7) {
      for (size_class_input in 1:nr_of_size_classes) {
        ...
        ds_classes_effect_size$abundance_d[
          ds_classes_effect_size$disturbance == disturbance &
          ds_classes_effect_size$patch_type == eco_metaeco_treatment &
