...
*Research question:* *do small patches that are connected to small or large patches have different median body size?*
...
*Should we keep P `(eco_metaeco_type)`?*
...
Single time points: see modeling choices.
