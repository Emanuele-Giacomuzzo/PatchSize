...
png(file = here("results", "figures", disturbance_global_input, "paper_small_patches.png"),
...
```{r}
### --- small patches - PRESENTATIONS --- ###

png(file = here("results", "figures", disturbance_global_input, "presentation_small_patches.png"),
