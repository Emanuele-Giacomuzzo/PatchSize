...
```{r}
p_biomass = plot.single.plot("total_metaecosystem_bioarea_mm2")
```
...
png(
  file = here("results", "figures", disturbance_global_input, "paper", "metaecosystems_biomass.png"),
  width = paper_width,
  height = paper_height,
  units = paper_units,
  res = paper_res
