...
png(file = here("results", "figures", disturbance_global_input, "paper_isolated_patches.png"),
    width = paper_width,
    height = paper_height,
    units = paper_units,
    res = paper_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_isolated_patches.png"),
