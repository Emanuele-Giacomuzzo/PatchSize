...
axis_names = data.frame(variable = NA,
  ...
  add_row(variable = "bioarea_mm2_per_ml", axis_name = "Biomass") %>%
  add_row(variable = "bioarea_mm2_per_ml_d", axis_name = "Bioamass ES") %>%
  add_row(variable = "bioarea_tot", axis_name = "Tot Biomass") %>%
  add_row(variable = "total_metaecosystem_bioarea_mm2", axis_name = "Tot Biomass") %>%
