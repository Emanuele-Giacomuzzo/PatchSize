...
for (set_input in 1:n_sets) {
  ...
  iterated_results_table$system_nr_unconnected_systems[nrow(iterated_results_table)] = paste(system_nr_unconnected_systems_input, collapse = " ")
}
```
</details> 
...
<details>
  <summary>Click for ΔAIC and p-value distributions</summary>
```{r}
...
<center>[**Reduced model**]{.underline} [**(with `connection`)**]{.underline}</center>
