...
*Warning in (function (iprint = 0L, maxfun = 10000L, FtolAbs = 1e-05, FtolRel = \## 1e-15, : unused control arguments ignored*

Ignore it, it just means that you didn't pass the control argument to the Nelder_Mead optimiser, so it uses the default.
...
Use as p-values and ΔAIC the mean of such distributions.
...
Display which system nr produced which AIC in the full model:
