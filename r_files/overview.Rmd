...
### CI
To calcula the 95% CI of the abundance of different size classes I used the following code: https://stackoverflow.com/questions/35953394/calculating-length-of-95-ci-using-dplyr, whose formula can be found here:
https://courses.lumenlearning.com/introstats1/chapter/a-single-population-mean-using-the-student-t-distribution/
