...
```{r abundance-large-single-patches-plots}
...
```{r abundance-large-patches-lnRR-plots}
for (disturbance_input in c("low", "high")){
...
```{r abundance-choose-time-points-large}
first_time_point = 2
last_time_point = 7
```
...
```{r abundance-large-patches-full-model}
...
```{r abundance-large-patches-no-TM}
...
```{r abundance-large-patches-no-TD}
...
```{r abundance-large-patches-no-PD}
...
```{r abundance-large-t2-t7-best-model}
best_model = no_PD
par(mfrow = c(2,3))
