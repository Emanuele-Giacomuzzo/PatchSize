update_all_models_table = function(model_name,
  ...
  all_models_table$mixed_R2[row] = mixed_R2_whole
  all_models_table$mixed_R2_metaeco[row] = mixed_R2_metaeco
  all_models_table$fixed_R2[row] = fixed_R2_whole
  all_models_table$fixed_R2_metaeco[row] = fixed_R2_metaeco
