...
### Medium-medium vs small-large meta-ecosystems
...
ds %>%
  group_by(day,eco_metaeco_type,system_nr) %>%
...
```{r child = here("r_files", "biomass", "sections", "S_S_and_S_L.Rmd")}
