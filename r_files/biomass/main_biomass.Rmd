...
```{r child = here("r_files", "biomass", "sections", "MM_SL_time_random.Rmd"), echo = TRUE, eval = TRUE}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_time_random.R"))
```

###### Time as fixed effect

```{r child = here("r_files", "biomass", "sections", "MM_SL_log.Rmd")}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_log.R"))
```

###### Fitted time function

```{r child = here("r_files", "biomass", "sections", "MM_SL_time_fitting.Rmd"), echo = TRUE, eval = TRUE}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_time_fitting.R"))
```

```{r child = here("r_files", "biomass", "sections", "MM_SL_time_fitted.Rmd"), echo = TRUE, eval = TRUE}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_time_fitted.R"))
```

###### Models table

```{r child = here("r_files", "biomass", "sections", "MM_SL_model_table.Rmd"), echo = TRUE, eval = TRUE}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_model_table.R"))
```
