...
#### Medium-Medium vs Small-Large {.tabset}
...
```{r MM_SL_time_random, child = here("r_files", "biomass", "sections", "MM_SL_time_random.Rmd"), echo = TRUE, eval = TRUE}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_time_random.R"))
```
...
```{r MM_SL_time_fitted, child = here("r_files", "biomass", "sections", "MM_SL_time_fitted.Rmd"), echo = TRUE, eval = TRUE}
source(here("r_files", "biomass", "extracted_sections", "MM_SL_time_fitted.R"))
```
...
```{r child = here("r_files", "biomass", "sections", "S-SS_and_S-SL.Rmd"), eval = FALSE}
source(here("r_files", "biomass", "extracted_sections", "S-SS_and_S-SL.R"))
```

```{r child = here("r_files", "biomass", "sections", "S_and_S-SL.Rmd"), eval = FALSE}
source(here("r_files", "biomass", "extracted_sections", "S_and_S-SL.R"))
```

```{r child = here("r_files", "biomass", "sections", "S_and_S-SS.Rmd"), eval = FALSE}
source(here("r_files", "biomass", "extracted_sections", "S_and_S-SS.R"))
```
...
```{r child = here("r_files", "biomass", "sections", "L_and_L-LL.Rmd"), eval = FALSE}
source(here("r_files", "biomass", "extracted_sections", "L_and_L-LL.R"))
```

```{r child = here("r_files", "biomass", "sections", "L_and_L-SL.Rmd"), eval= FALSE}
source(here("r_files", "biomass", "extracted_sections", "L_and_L-SL.R"))
```
