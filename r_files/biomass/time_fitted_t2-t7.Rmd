...
R2_metaecosystem = summary(model_9)$adj.r.squared - summary(model_10)$adj.r.squared
R2_metaecosystem = round(R2_metaecosystem, digits = 3)

```

Therefore, keeping t2 to t7 we get that the effect size of meta-ecosystem type is `r R2_metaecosystem`. 