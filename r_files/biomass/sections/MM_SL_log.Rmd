...
Another way of looking at the model is using the function `tab_model` of the packages `sjPlot` and `sjstats`. However, I'm not sure about how reliable their table is.
