...
*Should we keep the correlation between intercept and slopes (\|)?*
...
columns = c("model", "time_point", "AIC", "BIC", "R2", "R2_mixed", "R2_fixed", "R2_meta_mixed", "R2_meta_fixed")
