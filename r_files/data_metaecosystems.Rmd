...
```{r ds_metaecosystems-create-SL_SL_from_isolated, message=FALSE, results='hide', eval = recompute_analyses}
...
ds_metaecosystems = rbind(ds_metaecosystems, SL_from_isolated_all_combinations_together)

saveRDS(ds_metaecosystems, file = here("results", "ds_metaecosystems_isolated.RData"))
```
