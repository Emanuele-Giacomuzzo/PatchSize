...
```{r plot-alpha-diversity-of-large-patches-with-single-replicates}
ds_patches %>%
...
```{r choose-time-points-for-alpha-diversity-of-large-patches}
...
```{r create-full-model-large-alpha}
...
```{r large-t2-t7-best-model-small-alpha}
par(mfrow = c(2,3))
