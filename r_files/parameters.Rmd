...
axis_names = data.frame(variable = NA,
  ...
  add_row(variable = "shannon_d", axis_name = "Shannon Index ES") %>%
...
parameters_treatments = data.frame(treatment = NA,
  ...
  add_row(treatment = "Small connected to small", colour = "#fff7bc", linetype = "solid") %>%
  ...
  add_row(treatment = "Large connected to large", colour = "#fee0d2", linetype = "solid") %>%
  add_row(treatment = "Large connected to small", colour = "#67000d", linetype = "solid") %>%
  add_row(treatment = "Small-Small meta-ecosystem", colour = "#deebf7", linetype = "solid") %>%
  ...
  add_row(treatment = "Large-Large meta-ecosystem", colour = "#3182bd", linetype = "solid") %>%
...
results_table = data.frame(
  ...
  ΔAIC_full = NA,
  p_full = as.character(NA),
  ΔR2_full = NA,
  ΔAIC_int = NA,
  p_int = as.character(NA),
  ΔR2_int = NA,
  ΔAIC_fix = NA,
  p_fix = as.character(NA),
  ΔR2_fix = NA
) %>%
  slice(-1)
```