    ...
    for (time_point_input in first_time_point:last_time_point) {
      ...
      treatment_row = ds_patches_effect_size %>%
        filter(
          ...
          patch_type == eco_metaeco_treatment,
      ...
      control_row = ds_patches_effect_size %>%
        filter(
          disturbance == disturbance_regime,
          patch_type == eco_metaeco_control,
          time_point == time_point_input
        )
      ...
      hedges_d_bioarea = calculate.hedges_d(
        treatment_row$bioarea_per_ml_mean,
        treatment_row$bioarea_per_ml_sd,
        treatment_row$sample_size,
        control_row$bioarea_per_ml_mean,
        control_row$bioarea_per_ml_sd,
        control_row$sample_size
      )
      
      ds_patches_effect_size$bioarea_per_ml_d[
        ds_patches_effect_size$patch_type == eco_metaeco_treatment &
        ds_patches_effect_size$time_point == time_point_input &
        ds_patches_effect_size$disturbance == disturbance_regime] = 
        hedges_d_bioarea$d
      
      ds_patches_effect_size$bioarea_per_ml_d_upper[
        ds_patches_effect_size$patch_type == eco_metaeco_treatment &
        ds_patches_effect_size$time_point == time_point_input &
        ds_patches_effect_size$disturbance == disturbance_regime] = 
        hedges_d_bioarea$upper_CI
      
      ds_patches_effect_size$bioarea_per_ml_d_lower[
        ds_patches_effect_size$patch_type == eco_metaeco_treatment &
        ds_patches_effect_size$time_point == time_point_input &
        ds_patches_effect_size$disturbance == disturbance_regime] = 
