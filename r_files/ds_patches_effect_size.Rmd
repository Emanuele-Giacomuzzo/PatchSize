...
In this dataset (`ds_patches_effect_size`) each row represents a treatment at a time point. It contains the effect size of the connection of a patch (connected vs unconnected).
