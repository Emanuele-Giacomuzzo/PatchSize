...
```{r}
large_patches_biomass = plot.patches.points(ds_patches,
                                            patch_type_input,
                                            response_variable) %>%
  print()

p_large_biomass_presentations = plot.patches.points.presentations(ds_patches,
...
```{r child = here("r_files", "analysis_small_n_large_patches_special.Rmd")}
```
