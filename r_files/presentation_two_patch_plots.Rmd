...
```{r}
p_MM_SL_metaecos_alpha_1 = plot.metaecos.points(ds_metaecosystems, 
                                              metaecosystem_type_input,
                                              response_variable) %>%
  print()
```
...
```{r}
p_MM_SL_metaecos_alpha_2 = plot.metaecos.points(ds_metaecosystems, 
                                              metaecosystem_type_input,
                                              response_variable) %>%
  print()
```
...
```{r}
p_MM_SL_metaecos_alpha_3 = plot.metaecos.points(ds_metaecosystems, 
                                              metaecosystem_type_input,
                                              response_variable) %>%
  print()
```
...
```{r}
p_MM_SL_metaecos_beta_1 = plot.metaecos.points(ds_metaecosystems, 
                                             metaecosystem_type_input,
                                             response_variable) %>%
  print()
```
...
```{r}
p_MM_SL_metaecos_beta_2 = plot.metaecos.points(ds_metaecosystems, 
                                             metaecosystem_type_input,
                                             response_variable) %>%
  print()
```
...
```{r}
p_MM_SL_metaecos_beta_3 = plot.metaecos.points(ds_metaecosystems, 
                                             metaecosystem_type_input,
                                             response_variable) %>%
  print()
```
