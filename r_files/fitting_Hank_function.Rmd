...
Let's switch to [this following](https://khufkens.com/2016/10/02/paramater-estimation-in-r-a-simple-stomatal-conductance-model-example/).
...
#Cost function is here defined as the root mean squared error (RMSE) between the observed and the predicted values
...
- Error in fn(par, ...) : object 's' not found