...
```{r create-ds_lnRR_bioarea_density, eval = recompute_analyses}
...
saveRDS(ds_lnRR_bioarea_density, file = here("results", "biomass", "ds_lnRR_bioarea_density.RData"))
```

```{r}
ds_lnRR_bioarea_density = readRDS(here("results", "biomass", "ds_lnRR_bioarea_density.RData"))
...
```{r create-ds_lnRR_community_density, eval = recompute_analyses}
eco_metaeco_types = unique(ds_biomass_abund$eco_metaeco_type)
single_row = NULL
row_n = 0
...
saveRDS(ds_lnRR_community_density, file = here("results", "ds_lnRR_community_density.RData"))
```

```{r}
ds_lnRR_community_density = readRDS(here("results", "ds_lnRR_community_density.RData"))
