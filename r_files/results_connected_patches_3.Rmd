...
```{r}
png(file = here("results", "figures", disturbance_global_input, "paper_connected_patches_3.png"),
    width = paper_width,
    height = paper_height,
    units = paper_units,
    res = paper_res)
...
png(file = here("results", "figures", disturbance_global_input, "presentation_connected_patches_3.png"),
