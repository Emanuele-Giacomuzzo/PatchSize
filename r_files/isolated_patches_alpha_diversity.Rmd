...
2.  Construct a full model that captures all our hypotheses.\
    \
    The first hypothesis proposes that the Shannon index of isolated patches depends on their patch size (`patch_size_ml`). \
    \
    The second hypothesis proposes that the Shannon index of isolated patches goes down faster in smaller patches (`patch_size_ml : day`).
