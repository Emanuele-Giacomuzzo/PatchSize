...
full_model = lmer(
  jaccard_index ~
    ...
    metaecosystem_type +
    disturbance +
    baseline_jaccard_index + 
    day * metaecosystem_type +
    day * disturbance +
    day * baseline_jaccard_index +
