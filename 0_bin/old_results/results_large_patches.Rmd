...
png(file = here("results", "figures", disturbance_global_input, "paper_large_patches.png"),
    width = paper_width,
    height = paper_height,
    units = paper_units,
    res = paper_res)
...
```{r}
### --- Large patches - PRESENTATIONS --- ###

png(file = here("results", "figures", disturbance_global_input, "presentation_large_patches.png"),
